...
echo ''
printf "${titleBlue} СКРИПТ УСТАНОВКА ЗАПУЩЕН ... ${normal} \ n" | tee -a $logfile
echo ''
...
printf "${green} Устанавливаю приложение SAMBA ${normal} \ n"
sudo apt-get install -y samba samba-common-bin
printf "${green} Приложение успешно установлено ${normal} \ n"
